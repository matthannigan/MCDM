import pandas as pd
import seaborn
from bokeh.models import ColumnDataSource, DataTable, TableColumn, FactorRange, Legend, HoverTool
...
y_range = FactorRange(factors=df_ex_poor["y"].drop_duplicates().sort_values().tolist()[::-1])
